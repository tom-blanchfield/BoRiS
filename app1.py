...
genre_list = ["christmas", "santa", "snow", "comedy", "literature", "irish", "superheroes", "science", "young-adult", "science-fiction", "romance", "mystery", "fantasy", "horror",
...
st.title('Hi, I\'m BoRiS the Book Recommender System. You can type your favourite authors\' names and I will use their books as the seed for your recommendations. Once you\'ve selected all the authors you want to include, scroll to the bottom of the page and press "Get Recommendations!"\nAlternatively, you can select your favourite genres. When you do this, I will find the 10 top books for each genre and use them as the seed, so after you\'ve added your genres, scroll to the bottom of the page and press "Get Recommendations!"')
...
if st.button("Get Recommendations!"):
    if (selection_type == "Authors" and len(selected_authors) > 0) or (selection_type == "Genres" and len(selected_genres) > 0):
        ...
        closest_user_indices = user_similarities.argsort()[-15:-1]
